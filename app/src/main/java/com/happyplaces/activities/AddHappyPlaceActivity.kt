...
class AddHappyPlaceActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if(mHappyPlaceDetails!=null){
            ...
            mLatitude=mHappyPlaceDetails!!.latitiude
            mLongitude=mHappyPlaceDetails!!.longitude
            saveImg= Uri.parse(mHappyPlaceDetails!!.image)
            iv_place_image.setImageURI(saveImg)
                ...
                when{
                    ...
                    if(mHappyPlaceDetails==null){
                        ...
                        if(addHappyplace>0){
                            ...
                            if(update>0) {
                                Toast.makeText(this, "Updated sucessfully", Toast.LENGTH_LONG)
                                    .show()
                                setResult(Activity.RESULT_OK)
